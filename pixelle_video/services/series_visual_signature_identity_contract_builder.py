...
class SeriesVisualSignatureIdentityContractBuilder:
    def build(self, ip_profile: IPProfile) -> SeriesVisualSignatureIdentityContract:
        ...
        return SeriesVisualSignatureIdentityContract(
            ...
            metadata={
                "source": "IPProfile",
                "builder_version": "series_visual_signature_identity_contract_builder.v4_2",
                "series_visual_signature_profile_id": ip_profile.series_visual_signature_profile_id,
...
__all__ = ["SeriesVisualSignatureIdentityContractBuilder"]
