...
class VisualRoleProfileBuilder:
    def build(self, ip_profile: IPProfile | None) -> VisualRoleProfile:
        if ip_profile is None:
            raise VisualRoleProfileError("IPProfile is required to build VisualRoleProfile")
...
__all__ = ["VisualRoleProfileBuilder", "VisualRoleProfileError"]
