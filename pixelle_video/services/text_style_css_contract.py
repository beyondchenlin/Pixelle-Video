...
def render_text_style_css(
    ...
    *,
    ...
    """Render safe inline CSS from the shared text style contract."""
    style = style or {}
...
def text_style_lines(text: Any, style: Mapping[str, Any] | None) -> list[str]:
    value = str(text or "")
...
def resolve_text_style_layout(
    *,
    ...
    width = min(canvas_width * max_width_ratio, available_width)
    return TextStyleLayout(
        left=left,
        right=right,
        top=top,
