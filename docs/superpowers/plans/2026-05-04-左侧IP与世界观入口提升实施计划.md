...
```powershell
python -m pytest -q tests/test_content_input_storyboard_ui.py tests/test_style_config_text_rendering_ui.py -k "style_ip_context or standard_pipeline_passes_content_context"
```
