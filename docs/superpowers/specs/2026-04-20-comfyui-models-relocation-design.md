...
Move the full ComfyUI `models` directory from `C:\Users\ai\Documents\ComfyUI\models` to `E:\comfyui\comfyui\models` to free space on `C:`, while keeping the existing ComfyUI desktop setup working without changing its runtime behavior.
...
2. Move the full `models` directory to `E:\comfyui\comfyui\models`.
3. Create an NTFS directory junction at `C:\Users\ai\Documents\ComfyUI\models` that points to `E:\comfyui\comfyui\models`.
...
- Target relocated path: `E:\comfyui\comfyui\models`

## Verification Requirements

- Confirm `E:\comfyui\comfyui\models` exists after migration.
...
3. Move `E:\comfyui\comfyui\models` back to `C:\Users\ai\Documents\ComfyUI\models`.
