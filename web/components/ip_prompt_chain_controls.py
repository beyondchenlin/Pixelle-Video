...
def render_ip_prompt_chain_controls(
    *,
    ...
    visual_expression_mode = _select_valid_option(
        ui=ui,
        label=translate(f"{normalized_label_prefix}.visual_expression_mode"),
        key=_state_key(state_key_prefix, "visual_expression_mode"),
        options=[item.value for item in VisualExpressionMode],
        format_func=lambda value: translate(f"{normalized_label_prefix}.visual_expression_mode.option.{value}"),
    )
    visual_structure_mode = _select_valid_option(
        ui=ui,
        label=translate(f"{normalized_label_prefix}.visual_structure_mode"),
        key=_state_key(state_key_prefix, "visual_structure_mode"),
        options=[item.value for item in VisualRoleStructureMode],
        format_func=lambda value: translate(f"{normalized_label_prefix}.visual_structure_mode.option.{value}"),
    )
    visual_participation_mode = _select_valid_option(
        ui=ui,
        label=translate(f"{normalized_label_prefix}.visual_participation_mode"),
        key=_state_key(state_key_prefix, "visual_participation_mode"),
        options=[item.value for item in VisualRoleParticipationMode],
        format_func=lambda value: translate(f"{normalized_label_prefix}.visual_participation_mode.option.{value}"),
    )
    ...
    ui.caption(translate(f"{normalized_label_prefix}.visual_expression_mode_help"))
    ui.caption(translate(f"{normalized_label_prefix}.visual_structure_mode_help"))
    ui.caption(translate(f"{normalized_label_prefix}.visual_participation_mode_help"))
